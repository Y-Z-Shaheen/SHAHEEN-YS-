...
PROJECT_NAME="SHAHEEN-YS"
README_FILE="README.md"
BRANDING_FILE="BRANDING.md"

MAIN_LOGO_URL="https://i.postimg.cc/9XJ5yQZY/Picsart-26-07-21-04-44-19-389.png"

IMAGE_01_URL="https://i.postimg.cc/LsjpbFgS/Picsart-26-07-23-03-11-34-365.png"
IMAGE_02_URL="https://i.postimg.cc/W40vHcqT/Picsart-26-07-23-03-11-56-173.png"
IMAGE_03_URL="https://i.postimg.cc/Dz1TM34F/Picsart-26-07-23-03-12-22-367.png"
IMAGE_04_URL="https://i.postimg.cc/1zDQj1Vh/Picsart-26-07-23-03-20-52-434.png"

INSTAGRAM_URL="https://www.instagram.com/1.0_v_?igsh=N2N5MXNwN3p4ZDY2"
TELEGRAM_URL="https://t.me/Y9_S4"
TIKTOK_URL="https://www.tiktok.com/@zix8ii?_r=1&_d=f3c01a6371bii9&sec_uid="
FACEBOOK_URL="https://www.facebook.com/share/1HrfmU67VS/"
WHATSAPP_URL="https://wa.link/lc6f5w"
SUPPORT_URL="https://t.me/Y9_S4"

log() {
    printf '[23-readme-rebrand] %s\n' "$1"
}

error() {
    printf '[23-readme-rebrand][ERROR] %s\n' "$1" >&2
}
...
if [[ ! -d ".git" ]]; then
    error "المجلد الحالي ليس مستودع Git."
    exit 1
fi

log "بدء إعادة بناء README.md لمشروع ${PROJECT_NAME}..."

if [[ -f "$README_FILE" ]]; then
    BACKUP_FILE="README.md.before-shaheen-ys-rebrand-$(date +%Y%m%d-%H%M%S).bak"
    cp "$README_FILE" "$BACKUP_FILE"
    log "تم إنشاء نسخة احتياطية: ${BACKUP_FILE}"
fi

log "إنشاء README.md الجديد..."

cat > "$README_FILE" <<EOF
<div align="center">

<img src="${MAIN_LOGO_URL}" alt="${PROJECT_NAME} Logo" width="220"/>
